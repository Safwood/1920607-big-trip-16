...
export const generateRandomPrice = (eventType) => {
    return getRandomIntenger(possibleEventPrice[eventType].min, possibleEventPrice[eventType].max);
}
...
export const countTotalSum = (array) => {
    return array.reduce((accumulator, item) => {
        const offersPrice = item.offers.reduce((accumulator, item) => {
